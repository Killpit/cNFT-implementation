...
async function createTree() {
    const keypair = loadWalletKey("CNFTwx8MixUUGuTTsi7eSZbL8kFfufa4xnS8HQoyp2SP.json");
    const connection = new Connection("https://api.devnet.solana.com");
    const merkleTree = loadWalletKey("TREpiy61hapjTDbhJFhQ5zWaGroJWr9qkn8Cop3cAN8.json");
